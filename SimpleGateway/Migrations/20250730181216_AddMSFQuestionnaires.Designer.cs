...
namespace SimpleGateway.Migrations
{
    ...
    [Migration("20250730181216_AddMSFQuestionnaires")]
    partial class AddMSFQuestionnaires
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleGateway.Models.MSFResponse", b =>
                {
                    ...
                    b.Property<string>("CouldImproveUpon")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("DemonstrateIntegrity")
                        .HasColumnType("integer");

                    b.Property<string>("DoesParticularlyWell")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("EnableInformedDecisions")
                        .HasColumnType("integer");

                    b.Property<int>("EngageWithDevelopment")
                        .HasColumnType("integer");

                    b.Property<int>("FacilitateLearning")
                        .HasColumnType("integer");

                    b.Property<int>("InteractWithColleagues")
                        .HasColumnType("integer");

                    b.Property<int>("KeepPracticeUpToDate")
                        .HasColumnType("integer");

                    b.Property<int>("MSFQuestionnaireId")
                        .HasColumnType("integer");

                    b.Property<int>("ManageTimeResources")
                        .HasColumnType("integer");

                    b.Property<int>("MinimiseWasteEnvironment")
                        .HasColumnType("integer");

                    b.Property<int>("ParticipateInImprovement")
                        .HasColumnType("integer");

                    b.Property<int>("ProduceClearCommunications")
                        .HasColumnType("integer");

                    b.Property<int>("PromoteEqualityDiversity")
                        .HasColumnType("integer");

                    b.Property<int>("RecogniseCommNeedsPatients")
                        .HasColumnType("integer");

                    b.Property<int>("RecogniseImpactOnOthers")
                        .HasColumnType("integer");

                    b.Property<string>("RelationshipToPerformer")
                        .IsRequired()
                        .HasMaxLength(100)
                    ...
                    b.Property<int>("TreatPatientsWithCompassion")
                        .HasColumnType("integer");

                    b.Property<int>("WorkAsTeamMember")
                        .HasColumnType("integer");

                    b.Property<int>("WorkToStandards")
                        .HasColumnType("integer");

                    b.Property<int>("WorkWithinScope")
                        .HasColumnType("integer");

                    b.Property<string>("WorkingRelationshipDuration")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("SimpleGateway.Models.MSFResponse", b =>
                {
                    b.HasOne("SimpleGateway.Models.MSFQuestionnaire", "MSFQuestionnaire")
                        .WithMany("Responses")
                        .HasForeignKey("MSFQuestionnaireId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MSFQuestionnaire");
                });
