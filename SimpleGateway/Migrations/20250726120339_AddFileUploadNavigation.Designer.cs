...
namespace SimpleGateway.Migrations
{
    ...
    [Migration("20250726120339_AddFileUploadNavigation")]
    partial class AddFileUploadNavigation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SimpleGateway.Models.FileUploadEntry", b =>
                {
                    ...
                    b.Property<int>("FileUploadModelId1")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SimpleGateway.Models.FileUploadEntry", b =>
                {
                    ...
                    b.HasOne("SimpleGateway.Models.FileUploadModel", "FileUploadModel")
                        .WithMany()
                        .HasForeignKey("FileUploadModelId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
